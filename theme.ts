...
let themeConfigCache: StatusbarThemeConfig | null = null;
 ...
 */
export function loadThemeConfig(): StatusbarThemeConfig {
	const now = Date.now();
	...
	try {
		...
		console.debug(`[statusbar-theme] Failed to load ${themePath}:`, error);
	}
